...
class ChangementStep extends Model
{
    use HasFactory;
    ...
    /**
     * Get the changement that owns this step
     */
    ...
    /**
     * Get the user who validated this step (if validated_by is a user ID)
     */
     ...
     * Validate this step
     */
    public function validateStep(?string $userId = null, ?string $notes = null): void
    {
        $this->update([
            'status' => 'validated',
            'validated_by' => $userId,
     ...
     * Reject this step
     */
    public function rejectStep(?string $reason = null, ?string $userId = null, ?string $notes = null): void
    {
        $this->update([
            'status' => 'rejected',
            'rejected_at' => now(),
