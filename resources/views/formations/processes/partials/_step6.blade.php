    ...
    <div class="card-body">
        ...
        @else
            ...
            @if($showTbtFields)
                <div class="row mb-3">
                    <div class="col-md-12">
                        <label class="form-label fw-bold">{{ __('messages.feedback_tbx') }}</label>
                        <p class="text-muted">{{ $stepData['feedback_tbx'] ?? 'N/A' }}</p>
                    </div>
                </div>

                <div class="row mb-3">
                    <div class="col-md-12">
                        <label class="form-label fw-bold">{{ __('messages.nbr') }}</label>
                        <p class="text-muted">{{ $stepData['nbr'] ?? 'N/A' }}</p>
                    </div>
                </div>
            @endif
