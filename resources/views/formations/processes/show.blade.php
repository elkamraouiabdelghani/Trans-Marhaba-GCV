        ...
        <div class="row">
                            ...
                            @for($i = 1; $i <= 7; $i++)
                                @php
                                    ...
                                    $stepLabels = [
                                        ...
                                        5 => __('messages.step6_label'), // Training Delivery (formerly step 6)
                                        6 => __('messages.step7_label'), // Training Evaluation (formerly step 7)
                                        7 => __('messages.step8_label'), // Final Validation (formerly step 8)
                                    ];
                                @endphp
            ...
            <div class="col-lg-9">
                @php
                    ...
                    if ($currentStepNumber < 1 || $currentStepNumber > 7) {
                        $currentStepNumber = $formationProcess->current_step;
                        $currentStep = $formationProcess->getStep($currentStepNumber);
                    }
                @endphp

                @if($currentStepNumber && $currentStepNumber >= 1 && $currentStepNumber <= 7)
                    @include('formations.processes.partials._step' . $currentStepNumber, [
