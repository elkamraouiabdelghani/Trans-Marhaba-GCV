                        ...
                        <tbody>
                            @forelse($formationProcesses ?? [] as $formationProcess)
                                <tr class="border-bottom">
                                    <td class="py-3 px-4">
                                        <strong class="text-muted">#{{ $formationProcess->id }}</strong>
                                    </td>
                                    <td class="py-3 px-4">
                                        <div class="d-flex align-items-center">
                                    ...
                                    <td class="py-3 px-4">
                                        <span class="badge bg-info bg-opacity-25 text-info">
                                            {{ $formationProcess->formationType->name ?? 'N/A' }}
                                        </span>
                                    </td>
                                    <td class="py-3 px-4">
                                        @php
                                        ...
                                        <div class="w-100">
                                            <div class="progress mb-2" style="height: 20px;">
                                                <div class="progress-bar progress-bar-striped 
                                                    ...
                                                    aria-valuemin="0" 
                                                    aria-valuemax="100">
                                                    <small class="text-white fw-bold">{{ $formationProcess->current_step }}/8</small>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
