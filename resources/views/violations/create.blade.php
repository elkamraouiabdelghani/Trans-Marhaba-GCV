        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <form action="{{ route('violations.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                            @csrf
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    >
                                        ...
                                        @foreach($flottes as $flotte)
                                            <option
                                                value="{{ $flotte->id }}"
                                                @selected((int) old('flotte_id') === (int) $flotte->id)
                                            >
                                                {{ $flotte->name }}
                                            </option>
                                        @endforeach
                                ...
                                <div class="col-md-6">
                                    ...
                                    >
                                        ...
                                        @foreach($violationTypes as $type)
                                            <option 
                                                value="{{ $type->id }}"
                                                @selected((int) old('violation_type_id') === (int) $type->id)
                                            >
                                                {{ $type->name }}
                                            </option>
                                        @endforeach
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <div class="custom-driver-dropdown position-relative">
                                            <button
                                                ...
                                                aria-expanded="false"
                                            >
                                                <span id="driver_dropdown_display">{{ __('messages.select_driver') }}</span>
                                            </button>
                                ...
                                <div class="col-md-6">
                                    ...
                                    >
                                        ...
                                        @foreach($vehicles as $vehicle)
                                            <option 
                                                value="{{ $vehicle->id }}"
                                                @selected((int) old('vehicle_id') === (int) $vehicle->id)
                                            >
                                ...
                                <div class="col-md-6">
                                    ...
                                    >
                                        <option value="pending" @selected(old('status', 'pending') === 'pending')>{{ __('messages.pending') }}</option>
                                        <option value="confirmed" @selected(old('status') === 'confirmed')>{{ __('messages.confirmed') }}</option>
                                        <option value="rejected" @selected(old('status') === 'rejected')>{{ __('messages.rejected') }}</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
...
<style>
    ...
    /* Force 24-hour format for time inputs - hide AM/PM */
    input[type="time"] {
        direction: ltr;
    }
