        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white border-0 py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="mb-0 text-dark fw-bold">
                                ...
                                {{ __('messages.edit_formation_type') }}
                            </h5>
                    ...
                    <div class="card-body">
                        <form action="{{ route('formation-types.update', $formationType) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="name" 
                                       name="name" 
                                       value="{{ old('name', $formationType->name) }}" 
                                       required>
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="code" 
                                       name="code" 
                                       value="{{ old('code', $formationType->code) }}" 
                                       required>
                                @error('code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          id="description" 
                                          name="description" 
                                          rows="3">{{ old('description', $formationType->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3 form-check">
                                <input type="checkbox" 
                                       ...
                                       name="is_active" 
                                       value="1" 
                                       {{ old('is_active', $formationType->is_active) ? 'checked' : '' }}>
                            ...
                            <div class="mb-3 form-check">
                                <input type="checkbox" 
                                       ...
                                       name="obligatoire" 
                                       value="1" 
                                       {{ old('obligatoire', $formationType->obligatoire) ? 'checked' : '' }}>
