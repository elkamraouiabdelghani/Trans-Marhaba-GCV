                                ...
                                <div class="col-12">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <div>
                                            ...
                                            <small class="text-muted d-block" id="edit-location-coordinates-label">
                                                @php
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <p class="text-muted mb-4">
                                            {{ __('messages.checklist_optional_help') ?? 'Checklist is optional. Fill or update only the items you want for this rest point.' }}
                                        </p>
