        ...
        <div class="d-flex justify-content-between align-items-center mb-3 bg-white p-4 rounded-3 shadow-sm">
            <div>
                <h2 class="mb-1 fw-bold text-dark fs-4">
                    ...
                    {{ __('messages.rest_points_planning_title') ?? 'Rest points annual inspection plan' }}
                </h2>
            </div>
            <div>
                <a href="{{ route('rest-points.index') }}" class="btn btn-sm btn-outline-secondary">
        ...
        <div class="card border-0 shadow-sm mb-3">
            <div class="card-body p-3 d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <div class="d-flex align-items-center gap-2 flex-wrap">
                    <form method="GET" action="{{ route('rest-points.planning') }}" class="d-flex align-items-center gap-2">
                    ...
                    <form method="GET" action="{{ route('rest-points.planning.pdf') }}" target="_blank" class="d-flex align-items-center">
